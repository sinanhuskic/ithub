...
<div class="page-header">
    <h1 class="page-title">Novi partner</h1>
    ...
    <div class="card">
        ...
        <div class="form-group">
            ...
            <input type="text" id="name" name="name" class="form-input"
                   placeholder="npr. Općina Zavidovići" required>
        </div>

        <div class="form-group">
            <label class="form-label required">Logotip</label>
            <div class="logo-create-container">
                ...
                <label class="file-upload logo-upload-box">
                    <input type="file" name="logo" accept="image/*" required data-preview="logoPreview">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path>
                        <polyline points="17 8 12 3 7 8"></polyline>
                        <line x1="12" y1="3" x2="12" y2="15"></line>
                    </svg>
                    <p>Klikni za upload logotipa</p>
                    <span>ili prevuci sliku ovdje</span>
                </label>
            </div>
            <span class="form-hint" style="margin-top: 12px; display: block;">Preporučene dimenzije: 200x100px. Podržani formati: JPG, PNG, SVG, WebP</span>
        </div>
...
.logo-preview-box img[src]:not([src=""]) {
    display: block;
}

.logo-preview-box img[src]:not([src=""]) + .logo-preview-placeholder {
    display: none;
}
