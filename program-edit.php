...
$id = $_GET["id"] ?? null;
if (!$id) { header("Location: " . url("programs")); exit; }

$program = Program::findWithDecoded($id);
if (!$program) { header("Location: " . url("programs")); exit; }
...
<form method="POST" action="<?= url('programs/update/' . $program['id']) ?>" data-validate>
    ...
    <div class="card" style="margin-bottom: 24px;">
        ...
        <div class="form-grid">
            ...
            <div class="form-group" style="grid-column: span 2;">
                ...
                <textarea id="description" name="description" class="form-textarea" rows="3"><?= e($program['description']) ?></textarea>
            ...
            <div class="form-group">
                ...
                <select id="level" name="level" class="form-select">
                    ...
                    <option value="<?= e($key) ?>" <?= $program['level'] === $key ? 'selected' : '' ?>>
                        <?= e($label) ?>
                    </option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="form-group">
                ...
                <select id="status" name="status" class="form-select">
                    ...
                    <option value="<?= e($key) ?>" <?= $program['status'] === $key ? 'selected' : '' ?>>
                        <?= e($label) ?>
                    </option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="form-group">
                ...
                <select id="icon" name="icon" class="form-select">
                    ...
                    <option value="<?= e($key) ?>" <?= $program['icon'] === $key ? 'selected' : '' ?>>
                        <?= e($label) ?>
                    </option>
                    <?php endforeach; ?>
                </select>
        ...
        <div class="form-grid" style="margin-top: 20px;">
            <div class="form-group">
                <label class="form-check">
                    <input type="checkbox" name="featured" value="1" <?= $program['featured'] ? 'checked' : '' ?>>
                    <span class="form-check-label">Istaknut program</span>
                </label>
            </div>
            <div class="form-group">
                <label class="form-check">
                    <input type="checkbox" name="active" value="1" <?= $program['active'] ? 'checked' : '' ?>>
    ...
    <div class="card" style="margin-bottom: 24px;">
        ...
        <div class="form-grid">
            ...
            <div class="form-group" style="grid-column: span 2;">
                ...
                <textarea id="full_description" name="full_description" class="form-textarea" rows="5"><?= e($program['full_description']) ?></textarea>
            </div>

            <div class="form-group" style="grid-column: span 2;">
                <label class="form-label" for="requirements">Uslovi za upis</label>
                <textarea id="requirements" name="requirements" class="form-textarea" rows="3"><?= e($program['requirements']) ?></textarea>
            </div>
        </div>
    </div>
    ...
    <div class="card" style="margin-bottom: 24px;">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(180px, 1fr)); gap: 12px;">
            ...
            ?>
            <label class="form-check">
                <input type="checkbox" name="technologies[]" value="<?= e($key) ?>"
        ...
        <div id="highlights-container">
            ...
            <div class="form-group">
                <input type="text" name="highlights[]" class="form-input"
                       value="<?= e($highlight) ?>"
                       placeholder="<?= $index < 3 ? 'Unesite highlight...' : 'Dodaj još jedan...' ?>">
            </div>
            <?php endforeach; ?>
        </div>
    ...
    <div class="card">
        <div class="form-group">
            ...
            <input type="number" id="sort_order" name="sort_order" class="form-input"
                   value="<?= e($program['sort_order']) ?>" min="0" style="max-width: 150px;">
        ...
        <div style="display: flex; gap: 12px; margin-top: 24px;">
            ...
            <a href="<?= url('programs') ?>" class="btn btn-secondary">Odustani</a>
        </div>
    </div>
</form>
