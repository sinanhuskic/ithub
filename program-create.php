...
<div class="page-header">
    <h1 class="page-title">Novi program</h1>
...
<form method="POST" action="<?= url('program-store') ?>" data-validate>
    <?= Auth::csrfField() ?>
        ...
        <div class="form-grid">
            <div class="form-group" style="grid-column: span 2;">
                ...
                <input type="text" id="title" name="title" class="form-input"
                       placeholder="npr. Web Development" required>
            </div>

            <div class="form-group" style="grid-column: span 2;">
                <label class="form-label" for="description">Kratki opis</label>
                <textarea id="description" name="description" class="form-textarea" rows="3"
                          placeholder="Kratki opis programa koji će se prikazati na kartici..."></textarea>
        ...
        <div class="form-grid">
            <div class="form-group">
                ...
                <input type="text" id="period" name="period" class="form-input"
                       placeholder="npr. 04.10.2025. do 20.12.2025.">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="participants" name="participants" class="form-input"
                       placeholder="npr. 10 polaznika">
            </div>

            <div class="form-group" style="grid-column: span 2;">
                <label class="form-label" for="format">Format edukacije</label>
                <input type="text" id="format" name="format" class="form-input"
                       placeholder="npr. 10 edukacija × 4 sata, uživo u IT HUB Zavidovići">
            </div>

            <div class="form-group" style="grid-column: span 2;">
                <label class="form-label" for="full_description">Detaljni opis</label>
                <textarea id="full_description" name="full_description" class="form-textarea" rows="5"
                          placeholder="Detaljni opis programa..."></textarea>
            </div>
    ...
    <div class="card" style="margin-bottom: 24px;">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(180px, 1fr)); gap: 12px;">
            <?php foreach ($technologies as $key => $label): ?>
            <label class="form-check">
        ...
        <div id="highlights-container">
            <div class="form-group">
                <input type="text" name="highlights[]" class="form-input"
                       placeholder="npr. Praktičan rad na realnim projektima">
            </div>
            <div class="form-group">
                <input type="text" name="highlights[]" class="form-input"
                       placeholder="npr. Mentorstvo profesionalnog developera">
            </div>
            <div class="form-group">
                <input type="text" name="highlights[]" class="form-input"
                       placeholder="npr. Certifikat o završetku programa">
            </div>
            <div class="form-group">
                <input type="text" name="highlights[]" class="form-input"
                       placeholder="Dodaj još jedan...">
            </div>
            <div class="form-group">
                <input type="text" name="highlights[]" class="form-input"
                       placeholder="Dodaj još jedan...">
    ...
    <div class="card">
        <div class="form-group">
            ...
            <input type="number" id="sort_order" name="sort_order" class="form-input"
                   value="0" min="0" style="max-width: 150px;">
